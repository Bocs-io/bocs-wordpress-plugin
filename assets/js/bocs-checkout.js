jQuery(window).on('load', function() {
	...
	if(jQuery('div.wp-block-woocommerce-checkout-order-summary-totals-block').length > 0 && typeof bocsCheckoutObject.bocs !== 'undefined' && typeof bocsCheckoutObject.bocs !== undefined ){
		
		if(bocsCheckoutObject.bocs['products'].length > 0){
