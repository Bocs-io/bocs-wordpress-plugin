    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject'            => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => __('This controls the email subject line. Leave blank to use the default subject: <code>[Bocs] Your {site_title} subscription has been reactivated</code>.', 'bocs-wordpress'),
            ...
            'heading'            => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => __('This controls the main heading contained within the email notification. Leave blank to use the default heading: <code>Subscription Reactivated</code>.', 'bocs-wordpress'),
