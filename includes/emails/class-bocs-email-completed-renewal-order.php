...
class WC_Bocs_Email_Completed_Renewal_Order extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->description    = __('Completed renewal order emails are sent to customers when their renewal orders are marked completed.', 'bocs-wordpress');
    ...
    public function get_default_subject() {
        return __('[Bocs] Your {site_title} renewal order is complete', 'bocs-wordpress');
    }
    ...
    public function get_default_heading() {
        return __('Renewal Order Complete', 'bocs-wordpress');
    }
