...
/**
 * Completed Renewal Order Email Class
 *
 * @class    WC_Bocs_Email_Completed_Renewal_Order
 * @extends  WC_Email
 */
class WC_Bocs_Email_Completed_Renewal_Order extends WC_Email {

    /**
     * Constructor
     */
    public function __construct() {
        $this->id             = 'bocs_completed_renewal_order';
        $this->title         = __('Completed Renewal Order', 'bocs-wordpress-plugin');
        $this->description   = __('This email is sent to customers when their renewal order is completed.', 'bocs-wordpress-plugin');
    ...
    public function get_default_subject() {
        return __('Your renewal order is complete', 'bocs-wordpress-plugin');
    }
    ...
    public function get_default_heading() {
        return __('Renewal Order Complete', 'bocs-wordpress-plugin');
    }
