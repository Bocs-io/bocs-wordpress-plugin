<?php
/**
 * Bocs Processing Subscription Renewal Order Email Class
 *
...
if (!class_exists('WC_Bocs_Email_Processing_Order') && class_exists('WC_Email_Customer_Processing_Order')):

/**
 * Class WC_Bocs_Email_Processing_Order
 *
 * @package     Bocs\Emails
 * @version     1.0.0
 * @since       1.0.0
 ...
 * @category    Emails
 */
class WC_Bocs_Email_Processing_Order extends WC_Email_Customer_Processing_Order {
    ...
    public function __construct() {
        $this->id             = 'bocs_processing_order';
        $this->customer_email = true;
        $this->title          = __('[Bocs] Subscription Renewal Processing Order', 'bocs-wordpress');
        $this->description    = __('Subscription renewal processing order emails are sent to customers when their renewal order is processed.', 'bocs-wordpress');
        $this->template_html  = 'emails/bocs-customer-subscription-renewal-processing.php';
        $this->template_plain = 'emails/plain/bocs-customer-subscription-renewal-processing.php';
     ...
     * Get email subject.
     * 
     * Defines the default subject line for the processing order email.
     *
     * @since 1.0.0
    ...
    public function get_default_subject() {
        return __('[Bocs] Your {site_title} subscription renewal order has been received!', 'bocs-wordpress');
    }

    /**
     * Get email heading.
     * 
     * Defines the default heading for the processing order email.
     *
     * @since 1.0.0
     * @since 3.1.0 in WooCommerce core
    ...
    public function get_default_additional_content() {
        return __('Thanks for your continued subscription with us.', 'bocs-wordpress');
    }
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'subject'            => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => __('This controls the email subject line. Leave blank to use the default subject: <code>[Bocs] Your {site_title} order has been received!</code>.', 'bocs-wordpress'),
            ...
            'heading'            => array(
                ...
                'type'        => 'text',
                'desc_tip'    => true,
                'description' => __('This controls the main heading contained within the email notification. Leave blank to use the default heading: <code>Processing Order</code>.', 'bocs-wordpress'),
            ...
            'additional_content' => array(
                ...
                'placeholder' => __('Thanks for your business.', 'bocs-wordpress'),
                'type'        => 'textarea',
...
return new WC_Bocs_Email_Processing_Order(); 