// Fix for the Switch Bocs and Update Box buttons
jQuery(document).ready(function($) {
    console.log("Installing failsafe click handlers");
    // Fix the duplicate modalHelpers global issue
    window.modalHelpers = window.modalHelpers || { show: function(modalId) { $("#" + modalId).css("display", "flex").hide().fadeIn(200); }, hide: function(modalId) { $("#" + modalId).fadeOut(200); } };
