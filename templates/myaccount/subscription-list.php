...
wp_localize_script('bocs-subscriptions', 'bocsSubscriptionsData', array(
    ...
    'orderEndpoint' => wc_get_account_endpoint_url('bocs-edit-details', ''),
    'updateBoxEndpoint' => wc_get_account_endpoint_url('bocs-switch-bocs', ''),
            ...
            <div class="bocs-subscription-item" data-subscription-id="<?php echo esc_attr($subscription_id); ?>">
                ...
                <div class="bocs-subscription-details">
                    <div class="bocs-subscription-actions">
                        <button class="bocs-button edit-contents" data-sub-id="<?php echo esc_attr($subscription_id); ?>">Edit contents</button>
                        <button class="bocs-button change-box" data-sub-id="<?php echo esc_attr($subscription_id); ?>">Change box</button>
...
<div id="bocs-pause-subscription-modal" class="bocs-modal">
    <div class="bocs-modal-content">
        ...
        <div class="bocs-modal-actions">
            <button class="bocs-button modal-cancel">Cancel</button>
            <button class="bocs-button primary modal-confirm" id="pause-confirm-button" data-subscription-id="">Confirm Pause</button>
        </div>
    </div>
</div>
