...
// Processing message
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Thank you for your subscription renewal. It\'s currently being processed. Your order details are shown below for your reference:', 'bocs-wordpress') . '</p>';
...
$content .= '<p style="margin: 0 0 16px; color: #ffa000; font-weight: 600;">' . esc_html__('Renewal Order Processing', 'bocs-wordpress') . '</p>';
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Your subscription renewal order is being processed. We\'ll send you another email when it ships.', 'bocs-wordpress') . '</p>';
$content .= '</div>';
