...
// Note message
$content .= '<p style="margin: 0 0 16px;">The following note has been added to your order:</p>';
...
$content .= '<p style="margin: 0 0 16px; font-style: italic;">' . wpautop(wptexturize($customer_note)) . '</p>';
$content .= '</div>';
