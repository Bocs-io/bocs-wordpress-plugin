...
// Renewal message
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('This is a reminder that your subscription needs manual renewal.', 'bocs-wordpress') . '</p>';
...
$content .= '<p style="margin: 0 0 16px; color: #ffa000; font-weight: 600;">' . esc_html__('Action Required', 'bocs-wordpress') . '</p>';

// Next payment details
if ($subscription->get_date('next_payment')) {
    $content .= '<p style="margin: 0 0 16px;">';
    $content .= sprintf(
        esc_html__('Your subscription renewal payment of %1$s is due on %2$s.', 'bocs-wordpress'),
...
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Please click the button below to complete your renewal payment and keep your subscription active.', 'bocs-wordpress') . '</p>';
$content .= '</div>';
...
$content .= '<a href="' . esc_url($subscription->get_checkout_payment_url()) . '" style="display: inline-block; background-color: #3C7B7C; color: #ffffff; font-size: 16px; font-weight: bold; line-height: 100%; text-decoration: none; padding: 12px 25px; border-radius: 4px;">';
$content .= esc_html__('Complete Renewal Payment', 'bocs-wordpress');
$content .= '</a>';
$content .= '</div>';
...
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('If you have any questions about your subscription, please contact our customer support team.', 'bocs-wordpress') . '</p>';
