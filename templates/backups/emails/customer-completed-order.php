...
// Completed message
$content .= '<p style="margin: 0 0 16px;">We\'re happy to let you know that your order has been completed and your item(s) have been processed.</p>';

// Success status box
$content .= '<div style="background-color: #edf7ed; border-left: 4px solid #4CAF50; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">';
$content .= '<p style="margin: 0 0 16px; color: #2E7D32; font-weight: 600;">Your order is now complete!</p>';
$content .= '<p style="margin: 0 0 16px;">Thank you for shopping with us. We hope you enjoy your purchase.</p>';
$content .= '</div>';
