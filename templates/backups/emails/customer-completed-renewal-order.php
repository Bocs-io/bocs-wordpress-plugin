...
// Order completed message for subscription
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('We\'ve successfully processed your subscription renewal payment. Your order details are shown below for your reference:', 'bocs-wordpress') . '</p>';
...
$content .= '<p style="margin: 0 0 16px; color: #4caf50; font-weight: 600;">' . esc_html__('Renewal Order Complete', 'bocs-wordpress') . '</p>';
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Your subscription has been renewed successfully and is now active for the next billing period.', 'bocs-wordpress') . '</p>';
$content .= '</div>';
