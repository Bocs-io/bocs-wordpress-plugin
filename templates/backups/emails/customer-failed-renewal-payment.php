...
$content .= '<p style="margin: 0 0 16px;">Unfortunately, the automatic payment to renew your subscription has failed. Please update your payment information using the link below to avoid any interruption in your service.</p>';

// Alert box
$content .= '<div style="background-color: #fff6f6; border-left: 4px solid #C73333; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">';
$content .= '<p style="margin: 0 0 16px; color: #C73333; font-weight: 600;">Action Required</p>';
$content .= '<p style="margin: 0 0 16px;">Your subscription renewal payment has failed. Please update your payment method to continue your subscription.</p>';
$content .= '</div>';

// Payment button
$payment_url = $order->get_checkout_payment_url();
$content .= '<div style="margin: 40px 0;">';
$content .= '<a href="' . esc_url($payment_url) . '" style="display: inline-block; background-color: #3C7B7C; color: #ffffff; font-size: 16px; font-weight: bold; line-height: 100%; text-decoration: none; padding: 12px 25px; border-radius: 4px;">Update Payment Method</a>';
$content .= '</div>';
...
$content .= '<p style="margin: 0 0 16px;">If you need assistance, please contact our customer support team.</p>';
$content .= '<p style="margin: 0 0 16px;">We appreciate your business with Bocs.</p>';
$content .= '</div>';
$content .= '</div>';
