<?php
/**
 * Customer subscription reactivated email
 *
...
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Your subscription has been reactivated. Your subscription details are shown below for your reference:', 'bocs-wordpress') . '</p>';
...
$content .= '<p style="margin: 0 0 16px; color: #4caf50; font-weight: 600;">' . esc_html__('Subscription Reactivated', 'bocs-wordpress') . '</p>';
$content .= '<p style="margin: 0 0 16px;">' . esc_html__('Your subscription has been successfully reactivated and is now active.', 'bocs-wordpress') . '</p>';
