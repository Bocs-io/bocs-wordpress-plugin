...
if ($order->needs_payment()) {
    ...
    $content .= '<p style="font-size: 16px; margin-bottom: 15px;">An order has been created for you on ' . esc_html(get_bloginfo('name', 'display')) . '. Your invoice is below, with a link to make payment when you\'re ready.</p>';
    ...
    $content .= '<div style="background-color: #f8f9fa; border-left: 4px solid #3C7B7C; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">';
    $content .= '<p style="font-size: 16px; margin-bottom: 15px;">Thank you for your order. Your payment has been processed successfully and your order details are below.</p>';
    $content .= '</div>';
}
...
$content .= '<p style="margin: 0 0 16px;">Thanks for using Bocs. We hope you enjoy your purchase!</p>';
$content .= '</div>';
