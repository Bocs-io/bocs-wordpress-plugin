<?php
/**
 * Manual renewal reminder email (Bocs specific variant)
 *
...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <p style="margin: 0 0 16px;"><?php esc_html_e('This is a reminder to renew your subscription.', 'bocs-wordpress'); ?></p>
    ...
    <div style="background-color: #fff8e1; border-left: 4px solid #ffa000; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">
        <p style="margin: 0 0 16px; color: #ff6b00; font-weight: 600;"><?php esc_html_e('Renewal Reminder', 'bocs-wordpress'); ?></p>
        <p style="margin: 0 0 16px;"><?php 
            printf(
                esc_html__('Your subscription has expired or will expire soon. Please renew your subscription by %s to maintain access to your subscription benefits.', 'bocs-wordpress'),
                '<strong>' . esc_html(date_i18n(wc_date_format(), strtotime($subscription->get_date('end')))) . '</strong>'
            ); 
        ?></p>
    </div>
...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <div style="margin: 40px 0; text-align: center;">
        <a href="<?php echo esc_url($subscription->get_view_order_url()); ?>" style="display: inline-block; background-color: #3C7B7C; color: #ffffff; font-size: 16px; font-weight: bold; line-height: 100%; text-decoration: none; padding: 12px 25px; border-radius: 4px;">
            <?php esc_html_e('Renew Subscription', 'bocs-wordpress'); ?>
        </a>
    </div>
