...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <p style="margin: 0 0 16px;"><?php esc_html_e('Thank you for subscribing to Bocs! Your subscription has been successfully set up.', 'bocs-wordpress'); ?></p>
...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e5e5; color: #757575; font-size: 13px;">
        ...
        <p style="margin: 0 0 16px;"><?php esc_html_e('Thank you for subscribing to Bocs!', 'bocs-wordpress'); ?></p>
    </div>
</div>
