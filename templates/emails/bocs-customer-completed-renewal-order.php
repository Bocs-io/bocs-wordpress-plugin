<?php
/**
 * Bocs Customer Completed Renewal Order Email Template
 *
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <h2 style="color: <?php echo esc_attr($bocs_teal); ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 24px; text-align: left;">
                                <?php esc_html_e('Your subscription renewal order is complete', 'bocs-wordpress'); ?>
                            </h2>
                            ...
                            <p style="margin: 0 0 24px; font-size: 15px; line-height: 24px; color: #333333;">
                                <?php esc_html_e('We\'re pleased to let you know that your subscription renewal order has been completed and is ready for delivery. Your order details are shown below for your reference:', 'bocs-wordpress'); ?>
                            </p>
                            ...
                            <div style="background-color: #e8f5e9; border: 1px solid #4caf50; border-radius: 3px; padding: 15px; margin-bottom: 30px;">
                                <p style="margin: 0; color: #1b5e20; font-size: 14px; line-height: 21px;">
                                    <?php esc_html_e('Your subscription renewal order is now complete! Thank you for your continued business.', 'bocs-wordpress'); ?>
                                </p>
                            </div>
