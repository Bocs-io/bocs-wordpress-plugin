...
?>
                                                                        ...
                                                                        <div style="padding: 0 12px; max-width: 100%; margin-top: 30px;">
                                                                            <h2 style="display: block; font-size: 18px; font-weight: bold; line-height: 130%; margin: 16px 0 8px; text-align: left;">
                                                                                <?php esc_html_e('Customer Portal:', 'bocs-wordpress'); ?>
                                                                            </h2>
                                                                            
                                                                            <ul style="list-style-type: disc; padding-left: 20px; margin-bottom: 20px;">
                                                                                <li style="margin-bottom: 10px;">
                                                                                    <strong><?php esc_html_e('Update your box:', 'bocs-wordpress'); ?></strong>
                                                                                    <?php esc_html_e('Change products, qualities or swap your box for another.', 'bocs-wordpress'); ?>
                                                                                </li>
                                                                                <li style="margin-bottom: 10px;">
                                                                                ...
                                                                                <table cellspacing="0" cellpadding="0" border="0">
                                                                                    <tr>
                                                                                        <td style="padding-right: 15px;">
                                                                                            <a href="<?php echo esc_url(wc_get_account_endpoint_url('my-subscriptions')); ?>" style="background-color: #f0f0f0; border-radius: 4px; color: <?php echo esc_attr($base_color); ?>; display: inline-block; font-weight: bold; line-height: 100%; padding: 10px 15px; text-align: center; text-decoration: none;">
