<?php
/**
 * Subscription switched email (Bocs specific variant)
 *
...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <p style="margin: 0 0 16px;"><?php esc_html_e('Your subscription has been successfully switched.', 'bocs-wordpress'); ?></p>
    ...
    <div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">
        <p style="margin: 0 0 16px; color: #4caf50; font-weight: 600;"><?php esc_html_e('Subscription Switched', 'bocs-wordpress'); ?></p>
        <p style="margin: 0 0 16px;"><?php esc_html_e('Your subscription has been successfully switched to a new plan. Your updated subscription details are shown below.', 'bocs-wordpress'); ?></p>
    ...
    <div style="background-color: #fff8e1; padding: 12px 15px; margin-bottom: 25px; border-radius: 4px; border: 1px dashed #ffa000;">
        <p style="margin: 0 0 16px;"><span style="color: #ff6b00; font-weight: 500;"><?php esc_html_e('This subscription was switched through the Bocs App.', 'bocs-wordpress'); ?></span></p>
