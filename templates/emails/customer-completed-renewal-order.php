...
<div class="bocs-email-container">
    ...
    <p><?php esc_html_e('We\'re happy to let you know that your subscription renewal order has been completed. Your order details are shown below for your reference.', 'bocs-wordpress'); ?></p>
    ...
    <div class="subscription-details">
        <p>
            <span class="subscription-status status-active"><?php esc_html_e('Order Complete', 'bocs-wordpress'); ?></span>
        </p>
