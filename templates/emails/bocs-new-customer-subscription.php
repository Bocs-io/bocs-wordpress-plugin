...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <p style="margin: 0 0 16px;"><?php esc_html_e('Welcome to Bocs! Your first subscription has been successfully set up.', 'bocs-wordpress'); ?></p>
    ...
    <div style="background-color: #e8f5e9; border-left: 4px solid #4caf50; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">
        ...
        <p style="margin: 0 0 16px;"><?php esc_html_e('Your Bocs subscription has been processed successfully. You now have access to all subscription benefits.', 'bocs-wordpress'); ?></p>
    </div>
    
    <!-- Welcome to Bocs box -->
    <div style="background-color: #e3f2fd; border-left: 4px solid #2196f3; padding: 15px 20px; margin-bottom: 30px; border-radius: 4px;">
        <p style="margin: 0 0 16px; color: #2196f3; font-weight: 600;"><?php esc_html_e('Welcome to the Bocs Community!', 'bocs-wordpress'); ?></p>
        <p style="margin: 0 0 16px;"><?php esc_html_e('As a new Bocs customer, you\'re now part of our growing community. Thank you for choosing us for your needs.', 'bocs-wordpress'); ?></p>
    </div>
    ...
    <div style="background-color: #fff8e1; padding: 12px 15px; margin-bottom: 25px; border-radius: 4px; border: 1px dashed #ffc107;">
        ...
        <p style="margin: 0 0 16px;"><?php esc_html_e('You can manage your subscription and access all services directly through the Bocs mobile app.', 'bocs-wordpress'); ?></p>
    </div>
...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <div style="margin: 30px 0; padding: 20px; background-color: #f9f9f9; border-radius: 4px;">
        <h3 style="color: #333333; font-size: 18px; margin-top: 0;"><?php esc_html_e('Getting Started with Bocs', 'bocs-wordpress'); ?></h3>
        <ul style="padding-left: 20px; margin-bottom: 0;">
            <li style="margin-bottom: 10px;"><?php esc_html_e('Download the Bocs mobile app to manage your subscription', 'bocs-wordpress'); ?></li>
            <li style="margin-bottom: 10px;"><?php esc_html_e('Set up your profile to get personalized recommendations', 'bocs-wordpress'); ?></li>
            <li style="margin-bottom: 10px;"><?php esc_html_e('Explore the available features and services in your subscription', 'bocs-wordpress'); ?></li>
        </ul>
    </div>
