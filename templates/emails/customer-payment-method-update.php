<?php
/**
 * Customer Payment Method Update email
 *
...
<div class="bocs-email-container">
    <div class="bocs-email-content">
        ...
        <h2 class="bocs-header"><?php esc_html_e('Payment Method Update Required', 'bocs-wordpress'); ?></h2>
        ...
        <?php else : ?>
            <p><?php esc_html_e('We\'re contacting you regarding your subscription because your payment method needs to be updated. This could be because your card is expiring, has already expired, or has been declined.', 'bocs-wordpress'); ?></p>
        <?php endif; ?>
        ...
        <p><?php esc_html_e('To update your payment method, please log in to your account and navigate to the subscription details.', 'bocs-wordpress'); ?></p>
