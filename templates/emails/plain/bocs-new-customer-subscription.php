<?php
/**
 * New customer subscription confirmation email (Plain text - Bocs specific variant)
 *
...
echo sprintf(esc_html__('Welcome to %s!', 'bocs-wordpress'), esc_html(get_bloginfo('name'))) . "\n\n";
