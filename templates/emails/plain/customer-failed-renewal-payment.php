...
echo esc_html__('We\'re sorry, but the renewal payment for your subscription has failed. This could be due to an expired card, insufficient funds, or a change in your payment details.', 'bocs-wordpress') . "\n\n";
...
echo esc_html__('Please update your payment information in your account to avoid any interruption in your subscription. Here are the details of the order that failed to process:', 'bocs-wordpress') . "\n\n";
