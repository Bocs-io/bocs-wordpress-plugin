<?php
/**
 * Bocs Customer Subscription Renewal Processing Order Email (Plain Text)
 *
...
echo esc_html__('Just to let you know — we\'ve received your subscription renewal order and it is now being processed. Your order details are shown below for your reference:', 'bocs-wordpress') . "\n\n";

echo "========== SUBSCRIPTION RENEWAL CONFIRMATION ==========\n\n";

echo esc_html__('YOUR SUBSCRIPTION RENEWAL PAYMENT WAS SUCCESSFUL!', 'bocs-wordpress') . "\n";
echo esc_html__('Thank you for your continued support with Bocs.io!', 'bocs-wordpress') . "\n\n";
