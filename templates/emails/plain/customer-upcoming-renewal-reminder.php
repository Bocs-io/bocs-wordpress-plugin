...
if (!empty($renewal_date)) {
    echo sprintf(esc_html__('This is a friendly reminder that your subscription will renew on %s.', 'bocs-wordpress'), esc_html($renewal_date)) . "\n\n";
} else {
    echo esc_html__('This is a friendly reminder that your subscription will renew soon.', 'bocs-wordpress') . "\n\n";
}
