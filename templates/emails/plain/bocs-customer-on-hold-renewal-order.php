<?php
/**
 * Bocs Customer On-Hold Renewal Order Email (Plain Text)
 *
...
echo esc_html__('Thanks for your subscription renewal order. It\'s on-hold until we confirm your payment has been received. Your order details are shown below for your reference:', 'bocs-wordpress') . "\n\n";

echo "========== SUBSCRIPTION RENEWAL ON-HOLD ==========\n\n";

echo esc_html__('YOUR SUBSCRIPTION RENEWAL ORDER IS CURRENTLY ON-HOLD.', 'bocs-wordpress') . "\n";
echo esc_html__('We\'ll notify you once your payment has been confirmed and your order is processed.', 'bocs-wordpress') . "\n\n";
