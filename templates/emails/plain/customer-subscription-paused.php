...
echo "BOCS.IO - SUBSCRIPTION PAUSED\n\n";

/* translators: %s: Customer first name */
echo sprintf(esc_html__('Hi %s,', 'bocs-wordpress'), esc_html($subscription->get_billing_first_name())) . "\n\n";

echo esc_html__('Your subscription has been paused. No further payments will be processed until it\'s reactivated.', 'bocs-wordpress') . "\n\n";
...
echo esc_html__('You can reactivate your subscription at any time from your account.', 'bocs-wordpress') . "\n\n";

echo esc_html__('View subscription at:', 'bocs-wordpress') . "\n";
