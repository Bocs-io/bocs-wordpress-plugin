...
echo esc_html__('A new invoice has been generated for your subscription renewal order. To ensure uninterrupted service, please process this payment at your earliest convenience.', 'bocs-wordpress') . "\n\n";
