...
<div style="padding: 0 12px; max-width: 100%;">
    ...
    <?php if ( ! empty( $subscription->get_payment_method_title() ) ) : ?>
    <div style="background-color: #f8f9fa; padding: 15px 20px; margin-bottom: 25px; border-radius: 4px; border: 1px solid #e0e0e0;">
        ...
        <p style="margin: 0 0 16px;"><strong><?php echo esc_html($subscription->get_payment_method_title()); ?></strong></p>
        
        <?php if ( $subscription->get_payment_method() === 'stripe' ) : ?>
