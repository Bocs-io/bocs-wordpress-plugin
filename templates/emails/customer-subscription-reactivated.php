 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/customer-subscription-reactivated.php.
 *
...
<div class="bocs-email-container">
    <div class="bocs-email-content">
        ...
        <h2 class="bocs-header"><?php esc_html_e('Subscription Reactivated', 'bocs-wordpress'); ?></h2>

        <p><?php printf(esc_html__('Hi %s,', 'bocs-wordpress'), esc_html($subscription->get_billing_first_name())); ?></p>

        <p><?php esc_html_e('Great news! Your subscription has been successfully reactivated and is now active again.', 'bocs-wordpress'); ?></p>
        ...
        <p><?php esc_html_e('You can view your subscription details by clicking the button below.', 'bocs-wordpress'); ?></p>
