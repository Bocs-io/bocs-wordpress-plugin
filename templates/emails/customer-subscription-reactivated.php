...
<div class="bocs-email-container">
    ...
    <p><?php esc_html_e('Your subscription has been reactivated. Your subscription details are shown below for your reference:', 'bocs-wordpress'); ?></p>
    ...
    <div class="subscription-details">
        <p>
            <span class="subscription-status status-active"><?php esc_html_e('Active', 'bocs-wordpress'); ?></span>
        </p>
        <p>
            <?php 
            printf(
